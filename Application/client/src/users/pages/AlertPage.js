...
import { GuideIcon, LogoutIcon } from "../components/HeaderIcons"; // นำเข้า GuideIcon และ LogoutIcon
...
const AlertPage = () => {
  ...
  const handleYesClick = async () => {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:3008/api/patients/${patient_id}/send-message`, {
            method: 'POST',
            headers: {
